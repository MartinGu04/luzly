...
/** "הלוח שלי" page title + the displayed month, mirroring the dashboard header's restrained hierarchy: title strongest, month secondary, optional Hebrew-calendar range smallest. */
