 ...
 * freshness/content spacing was trimmed from `gap-6` to `gap-5` -- real
 * vertical space this page didn't need, part of removing a small
 * unnecessary page scroll at normal desktop viewport heights. The two-
 * column grid's OWN internal `gap-6` (between Hero/Timeline/etc.) is
 * unchanged.
 */
